...
Results show that our approach approximately reduce the execution time up to $57\%$ compared to the baseline, and up to $17\%$ compared to the VHAGaR Extension for 3X10 architecture. 
For CNN, our approach approximately reduces the execution time up to $78\%$ compared to the baseline, and approximately up to $54\%$ compared to the VHAGaR Extension
...
\caption{The lower and upper bounds for CNN architecture.
		\label{table_cnn0_1}}
\end{table}
