...
\item $\delta_1^{\text{vaghar}}\geq{\delta^c_{\text{diff}}}$
\end{itemize}
Then we can say:
$$ \delta_2 \leq\ C(x_2,c,N_2) \leq\ \delta^c_\text{diff}+C(x_1,c,N_1) $$
 \end{claim}
  Proof. \begin{itemize}
   ...
   $$ \rightarrow \delta_1^{\text{vaghar}} - C(x_1,c,N_2) \leq C(x_1,c,N_1)-C(x_1,c,N_2)\leq \delta^c_{\text{diff}} $$
   $$ \rightarrow \delta_1^{\text{vaghar}} - \delta^c_{\text{diff}} \leq C(x_1,c,N_2) $$
   We know that $\delta_1^{\text{vaghar}}\geq{\delta^c_{\text{diff}}}$ so we can say that $0 \leq C(x_1,c,N_2)$
   
   \item By the definition of vaghar we can say that $C(x_1,c,N_2)\leq(x_2,c,N_2)$. 
   \item For the same reasib, by the definition of vaghar we can say that $C(x_12,c,N_1)\leq(x_1,c,N_1)$. 
   ...
   \item So, in order to find the upper bound for $\delta_2^\text{vaghar}$ we need to know: $x_1,x_1^\epsilon, \delta^c_{\text{diff}}, \delta^{c_t}_{\text{diff}}$
